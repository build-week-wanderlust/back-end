...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String[] args) throws Exception {
        ...
        u2.getExperiences().add(new Experience("Alaska Seaplane Tour", "Departing from Ketchikan in our beautiful seaplane, our tour will take us through the Misty Fjords National Monument and north to the prehistoric land of the Alaska Glacier.", "Ketchikan", "AK", 550.00, "Professional", u2));
        u2.getExperiences().add(new Experience("Ketchikan Shore Excursion: Zodiac Boat Wilderness Adventure", "Leave your cruise ship behind for a few hours and steer a Zodiac boat in the waters of the Alaskan wilderness. This small-group guided shore excursion from Ketchikan is limited to just four people, and everyone takes a turn at the wheel. Cruise through rain-forest islands, into remote bays and inlets, and spot wildlife including eagles, seals, whales and bears. Enjoy a beachside snack and a boatman certificate to take home as a souvenir. Round-trip port transport is included.", "Ketchikan", "AK", 179.00, "Professional", u2));
