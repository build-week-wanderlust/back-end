...
@ApiModel(value = "Profile",
        description = "The Profile Entity")
@Entity
@Table(name = "profiles")
public class Profile extends Auditable {

    @ApiModelProperty(name = "profileid",
            value = "Primary Key for Profile",
            required = true,
            example = "1")
    @Id
    ...
    @ApiModelProperty(name = "firstname",
            value = "First Name of Profile",
            example = "Andrew")
    @Column
    private String firstname;

    @ApiModelProperty(name = "lastname",
            value = "Last Name of Profile",
            example = "Andrew")
    @Column
    ...
    @Pattern(regexp = "\\d{3}-\\d{3}-\\d{4}",
            message = "Telephone is only numbers 555-555-5555")
    @Column
    private String telephone;

    @ApiModelProperty(name = "about",
            value = "About the User",
            example = "Offering tours of Grand Canyon National Park")
